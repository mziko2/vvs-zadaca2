...
namespace Domari
{
    public abstract class Korisnik
    {
        ...
        public void PromjenaPassworda(string verifikacija, string novi)
        {
            ...
            {
                throw new FormatException("Lozinka mora sadržavati i brojeve i slova");
            }
            if (verifikacija.GetHashCode().ToString() != novi.GetHashCode().ToString())
            {
                throw new FormatException("Verifikacija nije jednaka passwordu");
            }
